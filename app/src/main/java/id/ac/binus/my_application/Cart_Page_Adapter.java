...
//        Toast.makeText(ctx, "produk id" + productID, Toast.LENGTH_SHORT).show();
        ...
        holder.prod_price_txt.setText("Price: " + String.valueOf(product_cart_vector.get(position).getProduct_price()));

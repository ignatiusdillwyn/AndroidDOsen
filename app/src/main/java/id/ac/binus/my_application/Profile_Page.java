...
public class Profile_Page extends AppCompatActivity {
    TextView username_tv, email_tv, phone_number_tv, DoB_tv, address_tv, wallet_tv, password_tv;
    ImageView edit_email_iv, edit_phone_number_iv, edit_DoB_iv, edit_address_iv, home_btn, cart_btn, edit_username_iv, edit_password_iv;
    Button logout_btn;
    ...
    NumberFormat format_rupiah = NumberFormat.getCurrencyInstance(locale_id);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wallet_tv.setText(format_rupiah.format(Double.parseDouble(String.valueOf(user.getWallet()))) + ",-");
